...
class ParsedLineTest {
    @Test
    fun appendHours() {
        assertEquals(SourceParsedLine.appendHours("00:00.123"), "00:00:00.123")
        assertEquals(SourceParsedLine.appendHours("00:00:00.123"), "00:00:00.123")
    }

    @Test
    fun timeFromMs() {
        assertEquals(SourceParsedLine.timeFromMs("16500.0 ms"), LocalTime.parse("00:00:16.5"))
        assertEquals(SourceParsedLine.timeFromMs("15500.5 ms"), LocalTime.parse("00:00:15.5005"))
    }
    ...
    fun matchResult() {
        ...
        val l = SourceParsedLine.fromConsole(string, AudioFile("", ""))
